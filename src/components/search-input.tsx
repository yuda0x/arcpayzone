...
export default function SearchInput() {
  ...
  return (
    <div className='w-full space-y-2'>
      <Button
        variant='outline'
        className='bg-background text-muted-foreground relative h-10 w-full justify-start rounded-[0.5rem] px-3 text-sm font-normal shadow-none sm:pr-12 md:w-48 lg:w-56'
